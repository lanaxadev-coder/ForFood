// ============================================================
// USER APP DRAWER — CALLBACKS WITH CONTEXT
// ============================================================
// Drawer for regular users.
// All callbacks receive BuildContext for proper navigation.
// ============================================================
...
class UserAppDrawer extends StatelessWidget {
  ...
  final void Function(BuildContext context) onMyOrders;
  final void Function(BuildContext context) onMyProfile;
  final void Function(BuildContext context) onDeliveryAddress;
  ...
  const UserAppDrawer({
    ...
    required this.onDeliveryAddress,
 ...
 Positioned(
    ...
    onTap: () => onMyProfile(context),  // ✅ Navigate to profile
  child:Container(
      width: 50,
      height: 50,
      decoration: const ShapeDecoration(
        color: Color.fromARGB(255, 245, 223, 113),  // Gray background
        shape: OvalBorder(),
      ),
      child: ClipOval(
        ...
        children: [
          ...
          SizedBox(
            ...
            _buildMenuItem(
              ...
              icon: 'assets/icons/adress.svg',
              text: 'Delivery Address',
              onTap: () => onDeliveryAddress(context),
            ),
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(
                left: textPosition.dx - iconPosition.dx - (isSmallIcon ? 32 : 40.30),
              ),
              child: SizedBox(
                width: 200,
                height: 31,
