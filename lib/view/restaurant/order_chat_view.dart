// ============================================================
// ORDER CHAT VIEW — restaurant ↔ user messaging per order
// ============================================================
...
class RestaurantOrderChatView extends StatelessWidget {
  final OrderModel order;

  const RestaurantOrderChatView({super.key, required this.order});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _RestaurantChatBody(order: order),
    );
  }
}
...
// BODY
// ============================================================
class _RestaurantChatBody extends StatefulWidget {
  final OrderModel order;

  const _RestaurantChatBody({required this.order});

  @override
  State<_RestaurantChatBody> createState() => _RestaurantChatBodyState();
}

class _RestaurantChatBodyState extends State<_RestaurantChatBody> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Send the customer a message if you need to clarify something.',
...
// MESSAGE BUBBLE
// ============================================================
class _RestaurantMessageBubble extends StatelessWidget {
  final ChatMessageModel message;
  final bool isMine;
  final double widthScale;

  const _RestaurantMessageBubble({
